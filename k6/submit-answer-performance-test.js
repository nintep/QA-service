...
export default function () {
  ...
  //load question page -- Note: when running the test, ensure that the database has a question with this id
  http.get("http://localhost:7800/questions/1");

  const data = {
    questionId: 1, //Note: when running the test, ensure that the database has a question with this id
